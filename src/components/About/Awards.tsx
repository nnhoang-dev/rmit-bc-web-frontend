                    ...
                    <div className='basis-1/2 px-2 sm:px-8 '>
                        <div className='flex flex-col items-center'>
                            <Image alt="Picture of the author"
                                ...
                                src={'me.png'}
                            />
                            <div className='font-bold my-3 text-xs sm:text-xl'>Best Club Of The Semester</div>
                            <div className='font-bold bg-primary py-0 px-4 text-white'>2022</div>
                        </div>
                        <div className='flex flex-col items-center mt-5'>
                            <Image alt="Picture of the author"
                                ...
                                src={'me.png'}
                            />
                            <div className='font-bold my-3 text-xs sm:text-xl'>Best Academic Event of The Year</div>
