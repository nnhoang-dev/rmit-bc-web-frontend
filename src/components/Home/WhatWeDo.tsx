...
const WhatWeDo = () => {
    return (
        <div className='w-full flex flex-col justify-center items-center pb-10 '>
            ...
            <p className='py-4 text-justify'>For Business Club, <q>Leader</q> is not a position but a direction, in which everyone has the opportunity to learn, contribute, capture value in return, and make yourself ready for challenges awaiting ahead. We aim to nurture future business leaders via value-added projects, knowledge discussions and career guidance</p>
