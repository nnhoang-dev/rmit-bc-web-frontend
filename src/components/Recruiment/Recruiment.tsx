    ...
    return (
        <div className='flex lg:flex-row flex-col'>
            <div className='basis-8/12'>
                {recruiment.map((v, i) => (
                    <div key={i} className='group flex justify-between items-center mb-4 cursor-pointer my-2 md:my-4 relative
                                            '>
                        <div className='basis-10/12 min-h-full  text-white p-4 sm:p-8 bg-gradient-to-r from-black from-[1%] to-primary 
                        ...
                        <div className='basis-2/12 font-bold text text-primary py-1 sm:px-2 flex justify-center items-center' >
            ...
            <div className='flex flex-col justify-center items-center basis-4/12 cursor-pointer'>
                ...
                <h2 className=' text-primary font-bold text-3xl'>Recruitment</h2>
